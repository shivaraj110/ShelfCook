      ...
      <View className="flex-1">
        ...
        <View className="px-4 pt-12 pb-6">
          <View className="items-center">
            ...
            <Text className="text-white/80 font-semibold text-md">
        ...
        {/* Preferences Section */}
        <ScrollView className="bg-white/90 rounded-t-3xl flex-1 px-4 pt-6">
          ...
          <View className="gap-y-[10px]">
            {preferences.map((pref) => (
              <View
                key={pref.label}
                className="flex-row items-center bg-white/60 p-4 rounded-[20px]"
              >
          ...
          <View className="gap-y-[10px] mt-8">
            <TouchableOpacity className="flex-row items-center bg-white/60 p-4 rounded-[20px]">
              <View className="bg-white/10 p-2 rounded-full">
